// THIS IS MODIFIED FOR WCAG COMPLIANCE
// - Vincent (Aug 28, 2017)
...
angular.module('md-table-progress.html', []).run(['$templateCache', function($templateCache) {
  $templateCache.put('md-table-progress.html',
    ...
    '    <span class="sr-only">Updating data table progress</span>' +
...
function mdHead($compile) {
  ...
  function postLink(scope, element, attrs, tableCtrl) {
    ...
    function addCheckboxColumn() {
      element.children().prepend('<th class="md-column md-checkbox-column"><span class="sr-only">Select</span>');
    }
